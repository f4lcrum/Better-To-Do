...
public class MainWindow {
    ...
    public MainWindow(DependencyProvider dependencyProvider) {
        ...
        templateFromEventAction = new CreateTemplateFromEventAction(eventTablePanel.getTable(), templateTablePanel.getTable(), this, dependencyProvider.getTemplateCrudService());
