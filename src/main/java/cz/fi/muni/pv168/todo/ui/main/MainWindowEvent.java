...
public class MainWindowEvent extends MainWindowEntityImpl<Event> {
    ...
    public MainWindowEvent(DependencyProvider dependencyProvider, BiConsumer<Integer, Boolean> onSelectionChange, ListModel<Category> categoryListModel,
                           ListModel<Template> templateListModel, ListModel<TimeUnit> timeUnitListModel, Column<Event, LocalDateTime> startDateRow, Runnable refreshStatistics) {
        ...
        this.buttonTabStrategy = new EventButtonTabStrategy(tablePanel.getTable(), categoryListModel, timeUnitListModel, templateListModel, this, dependencyProvider);
