...
public class MainWindow {
    ...
    public MainWindow(DependencyProvider dependencyProvider) {
        ...
        this.mainWindowTemplate = new MainWindowTemplate(dependencyProvider, this::changeActionsState, mainWindowCategory.getListModel(), mainWindowTimeUnit.getListModel());
        Column<Event, LocalDateTime> startDateRow = new Column<>("Start date and Time", LocalDateTime.class, Event::calculateStart);
        this.mainWindowEvent = new MainWindowEvent(dependencyProvider, this::changeActionsState, mainWindowCategory.getListModel(), mainWindowTemplate.getListModel(),
                mainWindowTimeUnit.getListModel(), startDateRow, this::refreshStatistics);
        ...
        tabbedPane.addTab("Events", mainWindowEvent.getTablePanel());
        tabbedPane.addTab("Templates", mainWindowTemplate.getTablePanel());
        tabbedPane.addTab("Categories", mainWindowCategory.getTablePanel());
        tabbedPane.addTab("Units", mainWindowTimeUnit.getTablePanel());
        ...
        frame.setJMenuBar(MainWindowHelper.createMenuBar(panelChangeListener, mainWindowEvent.getButtonTabStrategy(), mainWindowTemplate.getButtonTabStrategy(), mainWindowCategory.getButtonTabStrategy(),
                mainWindowTimeUnit.getButtonTabStrategy(), new ImportAction(mainWindowEvent.getTablePanel(), dependencyProvider.getImportService(), this::refresh),
                new ExportAction(mainWindowEvent.getTablePanel(), dependencyProvider.getExportService()), new QuitAction()));
        frame.add(MainWindowHelper.createToolbar(addButton, editButton, deleteButton, statusFilterPanel, categoryFilterPanel, durationFilterPanel, resetFiltersButton), BorderLayout.BEFORE_FIRST_LINE);
