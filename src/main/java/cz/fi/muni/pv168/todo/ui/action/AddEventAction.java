...
public final class AddEventAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        var dialog = new EventDialog(mainWindow.getCategoryCrudService(), createPrefilledEvent(), categoryListModel, timeUnitListModel, templateListModel, false, eventValidator, mainWindow.getCreateTemplateFromEventAction());
